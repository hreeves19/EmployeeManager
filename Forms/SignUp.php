            ...
            <form id="formLogin" action="../../EmployeeManager/Master/Server_Scripts/SignUpManager.php" method="post" accept-charset="UTF-8">
                ...
                <div class="form-group">
                    <div class="form-label-group">
                        ...
                        <select class="custom-select" name="gender" id="gender" required="required">
                ...
                <div class="form-group">
                    <div class="form-label-group">
                        ...
                        <select class="custom-select" name="State" id="State" required="required">
                ...
                <div class="form-group">
                    <div class="form-label-group">
                        ...
                        <select class="custom-select" name="Country" id="Country" required="required">
